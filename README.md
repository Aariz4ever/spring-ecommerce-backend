...
### 🔹 Base API Call
![Postman Screenshot](./ecomproject/screenshots/1.png)

### 🔹 Get all products (initially)
![Postman Screenshot](./ecomproject/screenshots/2.png)

### 🔹 Posting a Product
![Postman Screenshot](./ecomproject/screenshots/3.png)

### 🔹 Get Product of ID {1}
![Postman Screenshot](./ecomproject/screenshots/4.png)

### 🔹 Shown in Hibernate ORM
![Database Screenshot](./ecomproject/screenshots/5.png)

### 🔹 Posting another product (which increments id++) ie: id = 2
![Postman Screenshot](./ecomproject/screenshots/6.png)

### 🔹 Displaying all the products added so far
![Postman Screenshot](./ecomproject/screenshots/7.png)

### 🔹 Get Product details of ID {2}
![Postman Screenshot](./ecomproject/screenshots/8.png)

### 🔹 Shown in Database
![Database Screenshot](./ecomproject/screenshots/9.png)

### 🔹 Updating Product ID {1}
![Postman Screenshot](./ecomproject/screenshots/10.png)

### 🔹 Reflects update in Database
![Database Screenshot](./ecomproject/screenshots/11.png)

### 🔹 Deleting product ID {1}
![Postman Screenshot](./ecomproject/screenshots/12.png)

### 🔹 Displaying all the remaining products in the Database
![Postman Screenshot](./ecomproject/screenshots/13.png)

### 🔹 Shown in Database
![Database Screenshot](./ecomproject/screenshots/14.png)
